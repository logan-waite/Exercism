...
var author$project$Triangle$checkSides = function (n) {
	return (n <= 0) ? elm$core$Result$Err('Invalid lengths') : elm$core$Result$Ok(n);
};
var author$project$Triangle$checkTriangle = function (list) {
	if (A2(
		elm$core$List$any,
		function (n) {
			return _Utils_eq(
		...
		list)) {
		return elm$core$Result$Err('Invalid lengths');
	} else {
		_n0$2:
		while (true) {
			if (list.b) {
				if (!list.b.b) {
					var side = list.a;
					return elm$core$Result$Ok(author$project$Triangle$Equilateral);
				} else {
					if (!list.b.b.b) {
						var a = list.a;
						var _n1 = list.b;
						var b = _n1.a;
						return elm$core$Result$Ok(author$project$Triangle$Isosceles);
					} else {
						break _n0$2;
					}
				}
		...
		var sides = list;
		return elm$core$Result$Ok(author$project$Triangle$Scalene);
	}
};
...
var author$project$Triangle$triangleKind = F3(
	function (x, y, z) {
		return author$project$Triangle$checkTriangle(
			A2(
				elm$core$Debug$log,
				'current list',
				A2(
					elm$core$List$map,
					author$project$Triangle$checkSides,
					elm$core$Set$toList(
...
var author$project$Test$Generated$Main1418193533$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/triangle/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 303597575838881
	},
...
_Platform_export({'Test':{'Generated':{'Main1418193533':{'init':author$project$Test$Generated$Main1418193533$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8753.sock";
