...
var author$project$DifferenceOfSquares$square = function (n) {
...
var author$project$DifferenceOfSquares$squareOfSum = function (n) {
	return author$project$DifferenceOfSquares$square(
		elm$core$List$sum(
...
var author$project$DifferenceOfSquares$sumOfSquares = function (n) {
	return elm$core$List$sum(
		A2(
			elm$core$List$map,
			author$project$DifferenceOfSquares$square,
			A2(elm$core$List$range, 1, n)));
};
...
var author$project$Test$Generated$Main1261284144$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/difference-of-squares/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 366605757775856
	},
...
_Platform_export({'Test':{'Generated':{'Main1261284144':{'init':author$project$Test$Generated$Main1261284144$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-3477.sock";
