...
var author$project$GradeSchool$updateClass = F2(
		...
		return elm$core$Maybe$Just(
			elm$core$List$sort(
				A2(
					elm$core$List$cons,
					student,
					A2(elm$core$Maybe$withDefault, _List_Nil, _class))));
	});
...
var author$project$GradeSchool$addStudent = F3(
	function (grade, student, school) {
		return A3(
			...
			grade,
			author$project$GradeSchool$updateClass(student),
			school);
	});
...
var author$project$GradeSchool$studentsInGrade = F2(
	function (grade, school) {
		return A2(
			elm$core$Maybe$withDefault,
			_List_Nil,
			A2(elm$core$Dict$get, grade, school));
	});
...
var author$project$Test$Generated$Main1808870591$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/grade-school/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 108456575514712
	},
...
_Platform_export({'Test':{'Generated':{'Main1808870591':{'init':author$project$Test$Generated$Main1808870591$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-9251.sock";
