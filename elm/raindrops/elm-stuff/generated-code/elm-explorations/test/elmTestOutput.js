...
var author$project$Raindrops$raindrops = function (number) {
	var _n0 = _Utils_Tuple3(number % 3, number % 5, number % 7);
	if (!_n0.a) {
		if (!_n0.b) {
			if (!_n0.c) {
...
var author$project$Test$Generated$Main4174718408$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/raindrops/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 182307394282556
	},
...
_Platform_export({'Test':{'Generated':{'Main4174718408':{'init':author$project$Test$Generated$Main4174718408$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-14188.sock";
