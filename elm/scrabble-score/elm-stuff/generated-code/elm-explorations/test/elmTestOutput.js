...
var author$project$ScrabbleScore$getValue = function (letters) {
	if (letters.$ === 'Just') {
		var l = letters.a;
		return l.a;
	} else {
...
var author$project$ScrabbleScore$hasLetter = F2(
	function (_char, scores) {
		var _n0 = scores;
		var letters = _n0.b;
		return A2(elm$core$List$member, _char, letters);
	});
var author$project$ScrabbleScore$letterScores = _List_fromArray(
	[
		_Utils_Tuple2(
		1,
		_List_fromArray(
...
var author$project$ScrabbleScore$getLetterScore = function (_char) {
	return author$project$ScrabbleScore$getValue(
		elm$core$List$head(
			A2(
				elm$core$List$filter,
				author$project$ScrabbleScore$hasLetter(_char),
				author$project$ScrabbleScore$letterScores)));
};
var elm$core$List$sum = function (numbers) {
	return A3(elm$core$List$foldl, elm$core$Basics$add, 0, numbers);
};
var elm$core$String$toLower = _String_toLower;
var author$project$ScrabbleScore$scoreWord = function (word) {
	return elm$core$List$sum(
		A2(
			elm$core$List$map,
			function (c) {
				return author$project$ScrabbleScore$getLetterScore(c);
			},
...
var author$project$Test$Generated$Main1333434522$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/scrabble-score/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 119142878210015
	},
...
_Platform_export({'Test':{'Generated':{'Main1333434522':{'init':author$project$Test$Generated$Main1333434522$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-14826.sock";
