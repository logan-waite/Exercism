...
var author$project$PhoneNumber$checkProperLength = function (number) {
	var _n0 = function () {
		var _n1 = elm$core$String$uncons(number);
		if (_n1.$ === 'Just') {
			var result = _n1.a;
			return result;
		} else {
	...
	return (_Utils_eq(
		firstNum,
		_Utils_chr('1')) && (elm$core$String$length(number) === 11)) ? elm$core$Maybe$Just(rest) : ((elm$core$String$length(number) === 10) ? elm$core$Maybe$Just(number) : elm$core$Maybe$Nothing);
};
var elm$core$String$filter = _String_filter;
var author$project$PhoneNumber$getNumber = function (phoneNumber) {
	return author$project$PhoneNumber$checkProperLength(
		A2(elm$core$String$filter, elm$core$Char$isDigit, phoneNumber));
};
...
var author$project$Test$Generated$Main2147531983$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/phone-number/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 286424343394124
	},
...
_Platform_export({'Test':{'Generated':{'Main2147531983':{'init':author$project$Test$Generated$Main2147531983$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-19836.sock";
