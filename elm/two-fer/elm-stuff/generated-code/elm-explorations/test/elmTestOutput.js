...
var author$project$TwoFer$checkName = function (name) {
	if (name.$ === 'Just') {
		var n = name.a;
		return n;
	} else {
...
var author$project$TwoFer$twoFer = function (name) {
	return 'One for ' + (author$project$TwoFer$checkName(name) + ', one for me.');
};
...
var author$project$Test$Generated$Main614392728$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/two-fer/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 154431039319527
	},
...
_Platform_export({'Test':{'Generated':{'Main614392728':{'init':author$project$Test$Generated$Main614392728$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-18804.sock";
