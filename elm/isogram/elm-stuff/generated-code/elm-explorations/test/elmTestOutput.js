...
var author$project$Isogram$stringToList = function (string) {
	return A2(
		elm$core$List$filter,
...
var author$project$Isogram$isIsogram = function (sentence) {
	return _Utils_eq(
		elm$core$List$length(
			author$project$Isogram$stringToList(sentence)),
		elm$core$Set$size(
...
var author$project$Test$Generated$Main503049273$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/isogram/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 184973258693087
	},
...
_Platform_export({'Test':{'Generated':{'Main503049273':{'init':author$project$Test$Generated$Main503049273$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-61268.sock";
