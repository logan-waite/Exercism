...
var author$project$Leap$isLeapYear = function (year) {
	var notDivisibleByHundred = !(!A2(elm$core$Basics$modBy, 100, year));
	var divisibleByFourHundred = !A2(elm$core$Basics$modBy, 400, year);
	var divisibleByFour = !A2(elm$core$Basics$modBy, 4, year);
	return divisibleByFour && (notDivisibleByHundred || divisibleByFourHundred);
};
...
var author$project$Test$Generated$Main1286815848$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/leap/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 274743994405188
	},
...
_Platform_export({'Test':{'Generated':{'Main1286815848':{'init':author$project$Test$Generated$Main1286815848$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-26076.sock";
