...
var author$project$HelloWorld$helloWorld = function (name) {
	if (name.$ === 'Nothing') {
		return 'Hello, World!';
	} else {
		var val = name.a;
		...
		[
			...
			function (_n0) {
				return A2(
					...
					'Hello, World!',
					author$project$HelloWorld$helloWorld(elm$core$Maybe$Nothing));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Hello, Alice!',
					author$project$HelloWorld$helloWorld(
...
var author$project$Test$Generated$Main3467268948$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/hello-world/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 358470706401963
	},
...
_Platform_export({'Test':{'Generated':{'Main3467268948':{'init':author$project$Test$Generated$Main3467268948$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-55027.sock";
