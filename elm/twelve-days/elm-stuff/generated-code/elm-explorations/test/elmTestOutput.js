...
var author$project$TwelveDays$numToGift = function (n) {
	switch (n) {
		case 1:
...
var author$project$TwelveDays$listGifts = F2(
	function (n, list) {
		switch (n) {
			case 0:
				return list + '.';
			case 1:
				return (list === '') ? A2(
					author$project$TwelveDays$listGifts,
					n - 1,
					', ' + author$project$TwelveDays$numToGift(n)) : A2(
					author$project$TwelveDays$listGifts,
					n - 1,
					list + (', and ' + author$project$TwelveDays$numToGift(n)));
			default:
				return A2(
					author$project$TwelveDays$listGifts,
					n - 1,
					list + (', ' + author$project$TwelveDays$numToGift(n)));
		}
	});
var author$project$TwelveDays$numToCardinal = function (n) {
	switch (n) {
		case 1:
			return 'first';
		case 2:
...
var author$project$TwelveDays$makeLine = function (n) {
	return 'On the ' + (author$project$TwelveDays$numToCardinal(n) + (' day of Christmas my true love gave to me' + A2(author$project$TwelveDays$listGifts, n, '')));
};
var author$project$TwelveDays$recite = F2(
	function (start, stop) {
		return A2(
			elm$core$List$map,
			author$project$TwelveDays$makeLine,
...
var author$project$Test$Generated$Main2425141285$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/twelve-days/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 399996785346563
	},
...
_Platform_export({'Test':{'Generated':{'Main2425141285':{'init':author$project$Test$Generated$Main2425141285$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8933.sock";
