...
var author$project$Bob$isYelling = function (remark) {
	return elm$core$String$isEmpty(
		A2(
			elm$core$Debug$log,
			'is alpha',
			A2(elm$core$String$filter, elm$core$Char$isAlpha, remark))) ? false : (A2(
		elm$core$String$all,
		elm$core$Char$isUpper,
		A2(elm$core$String$filter, elm$core$Char$isAlpha, remark)) ? true : false);
};
...
var author$project$Test$Generated$Main2524855782$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/bob/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 246872639051689
	},
...
_Platform_export({'Test':{'Generated':{'Main2524855782':{'init':author$project$Test$Generated$Main2524855782$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-58863.sock";
