...
var author$project$Bob$isEmpty = function (remark) {
	return elm$core$String$isEmpty(
		elm$core$String$trim(remark));
};
...
var author$project$Bob$isYelling = function (remark) {
	var alphaString = A2(elm$core$String$filter, elm$core$Char$isAlpha, remark);
	return elm$core$String$isEmpty(alphaString) ? false : (A2(elm$core$String$all, elm$core$Char$isUpper, alphaString) ? true : false);
};
var author$project$Bob$hey = function (remark) {
	return author$project$Bob$isEmpty(remark) ? 'Fine. Be that way!' : ((author$project$Bob$isQuestion(remark) && author$project$Bob$isYelling(remark)) ? 'Calm down, I know what I\'m doing!' : (author$project$Bob$isQuestion(remark) ? 'Sure.' : (author$project$Bob$isYelling(remark) ? 'Whoa, chill out!' : 'Whatever.')));
};
...
var author$project$Test$Generated$Main355154339$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/bob/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 253487388711237
	},
...
_Platform_export({'Test':{'Generated':{'Main355154339':{'init':author$project$Test$Generated$Main355154339$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-15184.sock";
