...
var author$project$Hamming$compareStrands = F2(
	function (leftChar, rightChar) {
		return _Utils_eq(leftChar, rightChar) ? 0 : 1;
	});
	...
	function (left, right) {
		return (!_Utils_eq(
			...
			elm$core$List$sum(
				A3(
					elm$core$List$map2,
					author$project$Hamming$compareStrands,
...
var author$project$Test$Generated$Main3310522086$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/hamming/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 317663308380835
	},
...
_Platform_export({'Test':{'Generated':{'Main3310522086':{'init':author$project$Test$Generated$Main3310522086$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-17806.sock";
