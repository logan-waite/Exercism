...
var author$project$Accumulate$reduce = F3(
	function (func, initial, input) {
		reduce:
		while (true) {
			if (!input.b) {
				return initial;
				...
				var xs = input.b;
				var $temp$func = func,
					$temp$initial = A2(func, x, initial),
					$temp$input = xs;
				func = $temp$func;
...
var author$project$Accumulate$accumulate = F2(
	function (func, input) {
		return elm$core$List$reverse(
			A3(
				author$project$Accumulate$reduce,
				F2(
					function (i, result) {
						return A2(
							elm$core$List$cons,
...
var author$project$Test$Generated$Main2037194112$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/loganw/Exercism/elm/accumulate/tests/Tests.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 219603822681030
	},
...
_Platform_export({'Test':{'Generated':{'Main2037194112':{'init':author$project$Test$Generated$Main2037194112$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-55114.sock";
