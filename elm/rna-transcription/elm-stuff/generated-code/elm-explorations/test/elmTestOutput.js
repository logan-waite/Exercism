...
var author$project$RNATranscription$convertToRna = function (n) {
	switch (n.valueOf()) {
		case 'G':
			return _Utils_chr('C');
		case 'C':
...
var author$project$RNATranscription$toRNA = function (dna) {
	return elm$core$Result$Ok(
		A2(elm$core$String$map, author$project$RNATranscription$convertToRna, dna));
};
...
var author$project$Test$Generated$Main3211978091$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/logan/Exercism/elm/rna-transcription/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 166092198131310
	},
...
_Platform_export({'Test':{'Generated':{'Main3211978091':{'init':author$project$Test$Generated$Main3211978091$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-2084.sock";
